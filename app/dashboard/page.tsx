  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Email Search Form */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-10 border border-gray-100 animate-slide-up">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Enter your email to view all your bundles</p>
            </div>
          </div>
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 font-bold disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2 min-w-[140px]"
            >
              {loading ? (
                <>
